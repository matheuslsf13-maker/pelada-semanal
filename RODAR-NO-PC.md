# 💻 Rodar a Pelada Semanal no seu computador (Windows)

Passo a passo para ter o projeto inteiro em `C:\Playdesemana` e trabalhar nele
...
```powershell
cd C:\
git clone https://github.com/matheuslsf13-maker/play-da-semana.git Playdesemana
cd C:\Playdesemana
npm install
```
...
| `03-apelidos.sql` | apelidos dos jogadores (importação da lista) |
