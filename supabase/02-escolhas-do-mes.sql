-- ============================================================
--  Pelada Semanal — decisões de fechamento do mês
--  Rode este script no SQL Editor do Supabase (depois do schema.sql).
--  Guarda a escolha de cada jogador que fecha o mês em chamas:
...
-- mesma regra dos outros tabelas: todo mundo lê, só quem tem login escreve
