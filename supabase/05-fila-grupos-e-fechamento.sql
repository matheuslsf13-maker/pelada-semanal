-- ============================================================
--  Pelada Semanal — fila de partidas, modo em grupos e
...
alter table public.sessions
  add column if not exists format text not null default 'todos'
    check (format in ('todos', 'grupos'));
...
--     acontece no último play do mês.
-- ------------------------------------------------------------
