...
--  qualquer que os jogadores resolveram jogar) continua no histórico de cada
--  jogador e continua ajudando a equilibrar as duplas dos próximos plays,
