...
type Ctx = {
  ...
  /** Junta dois jogadores numa so, preservando partidas, pontos e sequencia. */
  ...
  const value = useMemo<Ctx>(() => {
    ...
    return {
      ...
      mergePlayers: (fromId, intoId) => {
        ...
        // partidas: a duplicada vira o jogador que fica
      ...
      // O nome de cadastro so aparece na tela de Jogadores.
      nameOf: (id) => {
        const p = byId.get(id)
        if (!p) return '—'
