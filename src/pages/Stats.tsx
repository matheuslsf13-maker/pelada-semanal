...
export default function Stats() {
  ...
  if (data.players.length === 0) {
    return (
      <div className="card">
        <Empty icon="📊">Cadastre os jogadores e registre um play para ver as estatísticas.</Empty>
      </div>
    )
  }
    ...
    <>
      <div className="card">
        <div className="segmented">
          <button className={modo === 'jogador' ? 'on' : ''} onClick={() => setModo('jogador')}>
            👤 Jogador
          </button>
...
function PainelJogador({
  ...
  // nao e desempenho do mes, e o que o app aprendeu sobre o atleta ate hoje
    ...
    <>
        ...
        {minhaForca ? (
          <>
            <div className="row" style={{ gap: 10 }}>
              ...
              <div className="grow" style={{ minWidth: 0 }}>
                ...
                <div className="tiny muted">
                  {posicaoNaForca}º mais forte de {totalNaForca}
            ...
            <p className="tiny muted" style={{ marginBottom: 0, marginTop: 8 }}>
              Não é o ranking do mês: a força atravessa o ano e mede <strong>com quem</strong>{' '}
        ...
        {statusUsados.length > 0 ? (
          <div className="stack" style={{ marginTop: 10 }}>
            {statusUsados.map((a) => {
              ...
              return (
                <div key={a.month} className="tiny" style={{ background: 'var(--ouro-suave)', color: 'var(--ouro)', borderRadius: 10, padding: '8px 10px' }}>
      ...
      <div className="card">
        ...
        {meusPares.length === 0 && meusRivais.length === 0 ? (
          ...
          <div className="stack">
            <Destaque icone="🤝" rotulo="Melhor parceria" par={melhorPar} tipo="parceiro" />
            <Destaque icone="😅" rotulo="Parceria mais difícil" par={parDificil} tipo="parceiro" />
      ...
      <div className="card">
        ...
        <TabelaPares linhas={meusPares} primeira="Parceiro" />
      </div>
        ...
        {jogos.map((j) => {
          ...
          return (
            <div key={j.id} className="row tiny" style={{ borderBottom: '1px dashed var(--line)', paddingBottom: 6 }}>
              ...
              <strong style={{ color: nosso > deles ? 'var(--verde)' : 'var(--muted)' }}>{nosso} x {deles}</strong>
              {nossosPts > 0 && <span style={{ color: 'var(--marca)', fontWeight: 800 }}>+{nossosPts}</span>}
            </div>
          )
        })}
      </div>
  ...
  return (
    <div>
      <div className="row spread tiny muted" style={{ marginBottom: 4 }}>
        ...
        <span style={{ fontWeight: 800, color: 'var(--marca)' }}>{Math.round(pct * 100)}%</span>
      </div>
 ...
 * o app aprendeu sobre o atleta desde sempre. Filtrar por mes daria um numero
 * que nao e usado para nada -- o equilibrio das duplas sempre le o total.
 */
function PainelForca() {
  ...
  if (linhas.length === 0) {
    return (
      <div className="card">
        <Empty icon="💪">Registre um play para o app começar a medir a força de cada um.</Empty>
      </div>
    )
  }
  ...
  return (
    <>
      <div className="card">
        <div className="section-title">💪 Força de cada atleta</div>
        <p className="tiny muted" style={{ marginTop: 0 }}>
          ...
          zera todo mês; a força atravessa o ano e mede <strong>com quem</strong> você ganhou:
          vencer quem está melhor rende muito mais, e vencer apertado rende pouco. 1500 é a média
          do grupo, e ela não se move — o que um ganha, o outro perde.
        </p>
      ...
      <div className="card">
        ...
        <p className="tiny muted" style={{ marginBottom: 0 }}>
          ...
          noite ruim ainda mexe demais nela. Quem nunca jogou não entra na lista — a nota dele seria
